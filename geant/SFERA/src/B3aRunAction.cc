...
{  
  ...
  analysisManager->CreateH1("Total Eabs","Total Edep in absorber", 200, 100.*keV, 2000*keV);

  // Creating ntuple
  //
  analysisManager->CreateNtuple("g4data", "Edep in crystals");
